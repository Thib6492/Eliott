...
<!-- SECTION PROGRAMME -->
<section id="programme" class="anchor">
    <div class="container text-center">
...
<!-- SECTION PARCOURS -->
<section id="parcours" class="anchor">
...
<section id="home-links">
    <div class="home-links__wrapper wrapper--grey">
        <a class="home-links__btn btn btn--secondary" href="biologie.php">Vos rendez-vous<br>biologie et nutrition</a>
        <a class="home-links__btn btn btn--secondary" href="sport.php">Votre sport<br>avec Eliott</a>
    </div>
</section>
