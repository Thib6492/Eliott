		...
		<div class="application__wrapper">
			...
			<div class="application__item">
				...
				<div class="application__item__content clearfix">
					...
					<div class="application__content">
						<p class="application__text application__text--strong">En complément de votre abonnement sportif, en salle ou à domicile, participez aux challenges qu’Eliott vous propose via le module «Activités» :</p>
						<ul class="application__list">
...
<?php
$first_link = "index.php#anchor-programme";
$first_text = "Votre</br>programme";
